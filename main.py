...
# Valid username and password dictionary
valid_credentials = {"admin": "0000"}
...
login_window.configure(bg="#292b2c")  # Darker background color

# Username label and entry
username_label = tk.Label(login_window, text="Username:", bg="#292b2c", fg="white", font=("Helvetica", 12))
username_label.pack(pady=(30, 0))
username_entry = tk.Entry(login_window, bg="#444", fg="white", font=("Helvetica", 12), highlightbackground="#444", highlightcolor="#444") # set highlightbackground and highlightcolor
username_entry.pack(pady=(0, 10), ipadx=5, ipady=5)

# Password label and entry
password_label = tk.Label(login_window, text="Password:", bg="#292b2c", fg="white", font=("Helvetica", 12))
password_label.pack()
password_entry = tk.Entry(login_window, show="*", bg="#444", fg="white", font=("Helvetica", 12), highlightbackground="#444", highlightcolor="#444") # set highlightbackground and highlightcolor
password_entry.pack(pady=(0, 10), ipadx=5, ipady=5)

# Login button styled
login_button = tk.Button(login_window, text="Login", command=authenticate_user, bg="#007bff", fg="white", font=("Helvetica", 12, "bold"), activebackground="#0056b3", activeforeground="white")
...
def open_main_window():
    ...
    def edit_room():
        ...
        win_editroom.geometry('300x300+583+284')
